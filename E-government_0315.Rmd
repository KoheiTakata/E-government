...
data_VD       <- read.csv("./data/VDem_data.csv")
...
VD_vars <- c("v2x_polyarchy", "v2x_accountability", "v2x_ex_confidence", "v2x_ex_direlect", "v2x_ex_hereditary",                  "v2x_ex_military", "v2x_ex_party", "v2x_neopat", "v2xnp_client", "v2xnp_pres", "v2xnp_regcorr", 
             "v2x_civlib", "v2x_clphy", "v2x_clpol", "v2x_clpriv", "v2xpe_exlecon", "v2xpe_exlgeo",
